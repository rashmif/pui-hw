...
document.body&&(e=document.body.clientWidth,h=document.body.clientHeight);pageHeight=b<h?h:b;pageWidth=a<e?a:e;return arrayPageSize=[pageWidth,pageHeight,e,h]}function p(a){var b=new Date;do var e=new Date;while(e-b<a)}a=jQuery.extend({overlayBgColor:"#000",overlayOpacity:.8,fixedNavigation:!1,imageLoading:lightbox_path+"images/lightbox-ico-loading.gif",imageBtnPrev:lightbox_path+"lightbox-btn-prev.gif",imageBtnNext:lightbox_path+"lightbox-btn-next.gif",imageBtnClose:lightbox_path+"lightbox-btn-close.gif",
imageBlank:lightbox_path+"lightbox-blank.gif",containerBorderSize:10,containerResizeSpeed:400,txtImage:"Image",txtOf:"of",keyToClose:"c",keyToPrev:"p",keyToNext:"n",imageArray:[],activeImage:0,captionPosition:"",shrinkToFit:!0,shrinkPadding:50,grouping:!0},a);var w=this;return this.unbind("click").click(function(){q(this,w);return!1})}})(jQuery);
